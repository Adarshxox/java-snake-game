...
public class GamePanel extends JPanel implements ActionListener {
    ...
    // Coordinates for snake's body parts
    ...
    char direction = 'R'; // Snake's initial direction: 'R' = right, 'L' = left, 'U' = up, 'D' = down
    ...
    public void newApple() {
        // Randomly position the apple within the window's grid
    ...
    // Custom key adapter class to control snake's direction
